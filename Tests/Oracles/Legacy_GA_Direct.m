% Test oracle copied verbatim from GA_Direct.m; only function name changed.
function TC = Legacy_GA_Direct(X, KInf, KSup, FInf, FSup, sw, di, sr, hw, hr, S, pij, n, lcmArray)
    % 1. 解码：直接分组的染色体含义变了
