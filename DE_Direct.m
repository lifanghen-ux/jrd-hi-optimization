function [bestTC,bestT,bestK,bestF,TCArray,TArray,KArray,FArray]  = DE_Direct(Gm, Np, KSup, KInf, FSup, FInf, sw, di, sr, hw, hr, S, pij, n)
...
F = 0.6;  % the bound of mutation operator
